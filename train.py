...
from models import UNet, UNetPlusPlus, U2Net  # 导入多种模型
from utils.data_loading import BasicDataset  # 数据集加载类
from utils.dice_score import dice_loss  # 自定义的Dice损失函数
...
if __name__ == '__main__':
    ...
    args = argparse.Namespace(
        model='unet',  # 模型名称，可选值："unet", "unet_c", "unet_s", "unet_cs", "unet++", "u2net"
