...
# 导入自定义的评估指标函数
from utils.dice_score import multiclass_dice_coeff, dice_coeff  # 导入计算Dice系数的函数
# multiclass_dice_coeff：用于多分类任务中计算Dice系数
# dice_coeff：用于二分类任务中计算Dice系数

from utils.iou_score import multiclass_iou_coeff, iou_coeff  # 导入计算IoU（Intersection over Union）系数的函数
# multiclass_iou_coeff：用于多分类任务中计算IoU系数
# iou_coeff：用于二分类任务中计算IoU系数

from utils.prec_score import precision  # 导入计算精确度（Precision）得分的函数

from utils.acc_score import accuracy  # 导入计算准确度（Accuracy）得分的函数
